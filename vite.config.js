...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'AgroAid Farms and Services Field Monitor',
        short_name: 'AgroAid Farms and Services Field',
        ...
        start_url: '/',
        icons: [
          { src: 'Logo - AgroAid Farms and Services.jpg', sizes: '192x192', type: 'image/png' },
          { src: 'Logo - AgroAid Farms and Services.jpg', sizes: '512x512', type: 'image/png' },
        ],
      },
    }),
  ],
